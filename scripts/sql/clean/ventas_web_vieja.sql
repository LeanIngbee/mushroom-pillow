...
with prepared as (
    select
        *,
        ...
        TRY_CAST(REPLACE(REPLACE(cast("total_products" as varchar), '.', ''), ',','.') as double ) as "gross_revenue",
        TRY_CAST(REPLACE(REPLACE(cast("total_paid_tax_incl" as varchar), '.', ''), ',','.') as double ) as "net_revenue"
